    ...
    style={{
      ...
      >
        ...
        <div className="flex items-center justify-center mb-10 space-x-20">
          ...
          <motion.span 
            className="text-white xl:pl-10 md:pr-10 font-bold text-6xl md:text-8xl"
        ...
        <motion.p 
          className="text-xl w-3/4 md:text-xl mt-4 xl:pl-20 xl:pr-20 ml-20 mr-20 text-center"
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1 }} 
